...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (!endApp)
        {
            ...
            // Ask the user to type the second number.
            Console.Write("Type another number (Optional - Only works for dd, avgef and crf), and then press Enter: ");
            ...
            Console.WriteLine("\tMTBF - Mean Time Between Failures");
            Console.WriteLine("\tAvailability - Availability");
            Console.WriteLine("\tcrf - Current Failure Intensity");
